function startGame(){
	...
	class fish{
		...
		change_target_pos(x1, y1){
			this.target_pos.x = x1;
			this.target_pos.y = y1;
			console.log("target_pos changed");
		}
		...
		upate(){
			...
			//console.log(this.current.x_pos,this.current.y_pos);
			//console.log(this.target_pos.x,this.target_pos.y);
		}
	...
	function detectCollisions(){
		...
		for (let index = 0; index < Fishs.length; index++) {
			Fishs[index].isColliding = false;
			//console.log(Fishs[index].isColliding);
		}
		...
		for (let i = 0; i < Fishs.length; i++){
			...
			for (let j = i + 1; j < Fishs.length; j++){
				obj2 = Fishs[j];
				// obj1.change_target_pos(obj1.current.x_pos -obj1.velocity.x*100,obj1.current.y_pos -obj1.velocity.y*100);
				// obj2.change_target_pos(obj2.current.x_pos -obj2.velocity.x*100,obj2.current.y_pos -obj2.velocity.y*100);
				//console.log(obj2.velocity.x);
